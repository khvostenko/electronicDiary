...
let StudentsByGroupComponent = class StudentsByGroupComponent {
    constructor(router, rs, activateRoute) {
        this.router = router;
        this.rs = rs;
        this.activateRoute = activateRoute;
        this.groupId = activateRoute.snapshot.params['id'];
        this.rs.get('students/group/' + this.groupId).subscribe((result) => {
            this.students = result.json();
        });
    }
};
StudentsByGroupComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
...
exports.StudentsByGroupComponent = StudentsByGroupComponent;
//# sourceMappingURL=studentsByGroup.component.js.map